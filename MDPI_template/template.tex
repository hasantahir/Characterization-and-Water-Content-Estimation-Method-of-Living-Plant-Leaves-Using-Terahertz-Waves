...
\newcommand{\orcidauthorF}{0000-0002-7097-9969} % Add \orcidB{} behind the author's name
...
\Author{Adnan Zahid $^{1,}$* \orcidA{}, Hasan T. Abbas $^{1,2,}$* \orcidB{}, Muhammad Ali Imran $^{1,}$\orcidC{}, Khalid A. Qaraqe $^{2,}$ \orcidE{} Akram Alomainy $^{3,}$\orcidD{}, and Qammer H. Abbasi $^{1,}$\orcidF{}}
...
\address{%
	$^{1}$ \quad School of Electronics and Nanoscale Engineering, University of Glasgow, Glasgow, U.K.; a.zahid.@research.gla.ac.uk, Muhammad.Imran@glasgow.ac.uk, Qammer.Abbasi@glasgow.ac.uk\\
	$^{2}$ \quad Department of Electrical and Computer Engineering, Texas A\&M University, Doha-Qatar; hasan.abbas@qatar.tamu.edu, khalid.qaraqe@qatar.tamu.edu\\
...
\corres{Correspondence: a.zahid.1@research.gla.ac.uk; Tel.: +441413311713, hasan.abbas@qatar.tamu.edu}
...
\begin{figure*}[t!]
	...
	\subfloat[Day 1]
	{
		\includegraphics[width=0.48\linewidth]{coffee_day1R.eps}
		\label{fig:day1}
	}
	\hfill
	\subfloat[Day 4]
	{
		\includegraphics[width=0.48\linewidth]{coffee_day4R.eps}
		\label{fig:day4}
	}
...
%	\label{fig:basil_eps}
%	\hfill
%	\subfloat[Coffee Arabica]{\includegraphics[width=0.31\textwidth]{coffeeleaf_perm.eps}}
%	\label{fig:coffee_eps}
%	\medskip
%	\subfloat[Aromatic Coriander]{\includegraphics[width=0.31\textwidth]{corianderleaf_perm.eps}}
...
%	\hfill
%	\subfloat[Mint Leaf]{\includegraphics[width=0.31\textwidth]{mintleaf_perm.eps}}
%	\label{fig:mint_eps}
%	\medskip
%	\subfloat[Parsley]{\includegraphics[width=0.31\textwidth]{parsleyleaf_perm.eps}}
%	\label{fig:parsley_eps}
%	\hfill
%	\subfloat[Peashoot]{\includegraphics[width=0.31\textwidth]{peashootleaf_perm.eps}}
%	\label{fig:peashoot_eps}
%	\hfill
%	\subfloat[Baby Spinach]{\includegraphics[width=0.32\textwidth]{spinachleaf_perm.eps}}
...
\begin{figure*}[b!]
	\centering
	\subfloat[Baby leaf]{\includegraphics[width=0.49\textwidth]{babyleaf_perm.eps}}
	\label{fig:baby_eps}
	\hfill
	\subfloat[Basil leaf]{\includegraphics[width=0.49\textwidth]{basilleaf_perm.eps}}
	\label{fig:basil_eps}
	
	\subfloat[Coffee Arabica]{\includegraphics[width=0.49\textwidth]{coffeeleaf_perm.eps}}
	\label{fig:coffee_eps}
	\hfill
	\subfloat[Aromatic Coriander]{\includegraphics[width=0.49\textwidth]{corianderleaf_perm.eps}}
	\label{fig:coriander_eps}
\end{figure*}
...
\begin{figure*}[h!]
	...
	\centering
	\subfloat[e][Lamb Lettuce]{\includegraphics[width=0.49\textwidth]{lettuceleaf_perm.eps}}
	\label{fig:lettuce_eps}
	\hfill
	\subfloat[Parsley]{\includegraphics[width=0.49\textwidth]{parsleyleaf_perm.eps}}
	\label{fig:parsley_eps}
	
	\subfloat[Peashoot]{\includegraphics[width=0.49\textwidth]{peashootleaf_perm.eps}}
	\label{fig:peashoot_eps}
	\hfill
	\subfloat[Baby Spinach]{\includegraphics[width=0.49\textwidth]{spinachleaf_perm.eps}}
	\label{fig:spinach_eps}
	\caption{Real part of permittivity of all eight leaves measured on four consecutive days. Leaves become transparent to electromagnetic waves with the passage of days as seen by the decrease in the permittivity.}
	\label{fig:Permittivity_all_leaves}
\end{figure*}
...
\begin{figure*}[bh!]
	\centering
	\subfloat[Baby leaf]{\includegraphics[width=0.49\textwidth]{babyleaf_ref.eps}}
	\label{fig:baby_n}
	\hfill
	\subfloat[Basil leaf]{\includegraphics[width=0.49\textwidth]{basilleaf_ref.eps}}
	\label{fig:basil_n}
	
	\subfloat[Coffee Arabica]{\includegraphics[width=0.49\textwidth]{coffeeleaf_ref.eps}}
	\label{fig:coffee_n}
	\hfill
	\subfloat[Aromatic Coriander]{\includegraphics[width=0.49\textwidth]{corianderleaf_ref.eps}}
	\label{fig:coriander_n}
\end{figure*}
\begin{figure*}[th!]
	\addtocounter{subfigure}{4}
	\centering
	\subfloat[Lamb Lettuce]{\includegraphics[width=0.49\textwidth]{lettuceleaf_ref.eps}}
	\label{fig:lettuce_n}
	\hfill
	%	\subfloat[Mint Leaf]{\includegraphics[width=0.49\textwidth]{mintleaf_ref.eps}}
	%	\label{fig:mint_n}
	\subfloat[Parsley]{\includegraphics[width=0.49\textwidth]{parsleyleaf_ref.eps}}
	\label{fig:parsley_n}
	
	\subfloat[Peashoot]{\includegraphics[width=0.49\textwidth]{peashootleaf_ref.eps}}
	\label{fig:peashoot_n}
	\hfill
	\subfloat[Baby Spinach]{\includegraphics[width=0.49\textwidth]{spinachleaf_ref.eps}}
	\label{fig:spinach_n}
